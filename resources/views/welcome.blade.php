...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto">
        ...
        <h1 class="sitename">BISNIS DIGITAL</h1>
      </a>
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#services">Civitas</a></li>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p>
              Program Studi Sarjana Terapan Bisnis Digital dilatarbelakangi oleh tingginya angka usia produktif (bonus demografi) namun tidak seimbang dengan fakta bahwa lapangan pekerjaan yang terbatas sehingga berpotensi menjadi beban masyarakat dan masalah sosial (social problem). Memasuki era revolusi industri 4.0 pemanfaatan teknologi informasi meningkat pesat ternasuk terbukanya potensi usaha baru berbasis teknologi informasi srhingga menyebabkan tingginya permintaan tenaga profesional di bidang teknologi informasi serta inovator baru yang bergerak dalam bisnis digital. Program Studi Sarjana Terapan Bisnis Digital berpotensi memberikan kontribusi dalam menyediakan tenaga kerja profesional dan calon wirausaha bidang bisnis digital.
            </p>
          </div>

          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <p>Program Studi Sarjana Terapan Bisnis Digital memberikan kontribusi untuk memperkuat penciptaan bisnis kreatif digital, startup, pengembangan desa, agro dan ekowisata berbasis digital, kewirausahaan yang berbasis sosial dan teknologi (Sosio Technopreneur) dalam mengatasai permasalahan di masyarakat terutama di pedesaan khususnya dalam bidang pertanian. Memberikan porsi praktikum dalam bentuk workshop yaitu dalam proses pemebelajaran terjadi kesinambungan antara teori yang diajar tiap semester dengan workshop tiap semester sehingga mahasiswa bisa mengeksplorasi masalah, membuat solusi dari permasalahan sampai dengan membangun produk inovasi bisnis digitalnya.</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
            ...
            <div class="content px-xl-5" data-aos="fade-up" data-aos-delay="100">
              <h3><span>Politeknik Negeri Jember untuk menjadi Politeknik Unggul di Asia Tahun 2035 yang </span><strong>merupakan wujud dari landasan penentuan profil lulusan yang sesuai dengan kebutuhan era digital saat ini.</strong></h3>
            </div>
            ...
            <div class="faq-container px-xl-5" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="faq-item faq-active">
                ...
                <div class="faq-content">
                   <h3><span>01</span></h3>
                  <p>Menyelenggarakan pendidikan vokasi program sarjana yang bertujuan menghasilakn sarjana trepan bidang Bisnis Digital yang memeliki kompetensi sebagai Digital entrepreneur (Wirausaha Digital),</p>
                   <h3><span>02</span></h3>
                  <p>Memperkuat landasan keilmuan teknologi informasi di bidang bisnis digital untuk pengembangan IPTEKS dan dapat diterapkan di masyarakat.</p>
                   <h3><span>03</span></h3>
                  <p>Menjalin sinergi pendidikan sarjana terapan dengan kegiatan penelitian dan pengabdian yang bersifat berkelanjutan, mendalam, lintas disiplin yang menghasilkan solusi untuk permasalahan bangsa.</p>
                   <h3><span>04</span></h3>
                  <p>Menjalin kerjasama dengan institusi dan industri yang mendukung Program Studi Sarjana Terapan Bisnis Digital baik dalam maupun luar negeri.</p>
                </div>
              ...
              <div class="faq-item faq-active">
                ...
                <div class="faq-content">
                  <h3><span>01</span></h3>
                  <p>Mendidik mahasiswa yang ahli dan kompeten di bidang bisnis digital.</p>
                   <h3><span>02</span></h3>
                  <p>Mengembangkan kreativitas dan inovasi mahasiswa dalam rangka pengembangan IPTEKS yang dapat diterapkan di masyarakat.</p>
                   <h3><span>03</span></h3>>
                  <p>Menghasilkan lulusan sarjana terapan dibidang bisnis digital yang berbasis IPTEKS, bermoral tinggi, berkualitas dan berintegritas.</p>
                   <h3><span>04</span></h3>
                  <p>Berperan aktif dalam kegiatan yang mendukung program bisnis digital terapan baik di dalam maupun luar negeri.</p>
                   <h3><span>05</span></h3>
                  <p>Membangun dan mengembangkan jaringan kerja nasional dan kolaborasi internasional baik dalam penelitian atau mencari solusi untuk permasalahan bangsa.</p>
                </div>
                <i class="faq-toggle bi bi-chevron-right"></i>
              </div><!-- End Faq item-->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <div class="skills-content skills-animation">
              ...
              <div class="progress">
                <span class="skill"><span>Digital Entrepreneur</span> <i class="val">100%</i></span>
              ...
              <div class="progress">
                <span class="skill"><span>Business Analyst</span> <i class="val">90%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill"><span>Profesional in Digital Biusiness</span> <i class="val">75%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill"><span>Smart Village Developer</span> <i class="val">55%</i></span>
                <div class="progress-bar-wrap">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Ruang Workshop Studio Mini</a></h4>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Multimedia Cerdas</a></h4>
            </div>
          </div><!-- End Service Item -->

          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="350">
            <div class="service-item position-relative">
              <div class="icon"><i class="bi bi-broadcast icon"></i></div>
              <h4><a href="" class="stretched-link">Arsitektur Jaringan Komputer</a></h4>
            </div>
          </div><!-- End Service Item -->
  ...
  <footer id="footer" class="footer">
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="d-flex align-items-center">
            <span class="sitename">Bisnis Digital</span>
          </a>
          <div class="footer-contact pt-3">
            <p>Kampus 2 Bondowoso</p>
            <p>Jl. KH. Wahid Hasyim No 41, Bondowoso - Jawa Timur</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+62 851-7959-0160</span></p>
            <p><strong>Email:</strong> <span>politeknik@polije.ac.id</span></p>
          </div>
        </div>
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="#">Civitas</a></li>
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">Bisnis Digital</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
        <!-- All the links in the footer should remain intact. -->
        <!-- You can delete the links only if you've purchased the pro version. -->
        <!-- Licensing information: https://bootstrapmade.com/license/ -->
        <!-- Purchase the pro version with working PHP/AJAX contact form: [buy-url] -->
        Designed by <a>Dwi Purbo Safitri</a>
